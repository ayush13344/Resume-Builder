...
const Testimonial = () => {
    ...
    return (
        ...
        `}</style>
            <div id='testimonial' className='flex flex-col items-center my-10 scroll-mt-2'>
                ...
                <div className="flex items-center space-x-2.5 border border-green-500/30 rounded-full bg-green-500/20 p-1 text-sm text-green-600">
                    ...
                    <div className="flex items-center space-x-1 bg-green-500 text-white border border-green-500 rounded-3xl px-3 py-1">
                        <BookUserIcon className="size-4.5 stroke-white-600" />
                    </div>
                    <p className="pr-3">Testimonial</p>
                </div>

                <Title title="Don't just take our words" description="Hear what our user say about us .We're looking ways to improve" />
            </div>
