    ...
    return (
        <div id='features' className='flex flex-col items-center my-10 scroll-mt-12'>
            ...
            <div className="flex items-center space-x-2.5 border border-green-500/30 rounded-full bg-green-500/20 p-1 text-sm text-green-600">
                ...
                <p className="pr-3">Simple Process</p>
            </div>
            <Title title="Build your resume" description="Explore the powerful features that make our product stand out." />
            ...
            <div className="flex flex-col md:flex-row items-center xl:-mt-20">
